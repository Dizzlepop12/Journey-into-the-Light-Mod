...
import net.journey.client.server.bars.darkEnergy.MessageDarkEnergyBar;
import net.journey.client.server.bars.essence.MessageEssenceBar;
...
public class Journey {
	...
	public static void preInit(FMLPreInitializationEvent event) {
		...
		event.getModMetadata().credits = SlayerAPI.Colour.BLUE + "The_SlayerMC - Creator/Developer, Dizzlepop - Developer";
