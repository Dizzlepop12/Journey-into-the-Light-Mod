package net.journey.blocks.container;
...
public class ContainerTrophy extends Container {

	public IInventory tableInventory;
	private World world;

	public ContainerTrophy(InventoryPlayer inventory, TileEntityTrophyTable entity, World w) {
		world = w;
