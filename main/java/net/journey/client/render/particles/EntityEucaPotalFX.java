...
public class EntityEucaPotalFX extends Particle {
	
    private float portalParticleScale;
    private double portalPosX, portalPosY, portalPosZ;

    public EntityEucaPotalFX(World var1, double var2, double var4, double var6, double var8, double var10, double var12) {
        ...
        this.particleBlue = 0.0F * rand.nextFloat();
        this.particleGreen = 0.2F * rand.nextFloat();
    ...
    @Override
    public void renderParticle(VertexBuffer p_180434_1_, Entity p_180434_2_, float par2, float p_180434_4_, float p_180434_5_, float p_180434_6_, float p_180434_7_, float p_180434_8_) {
