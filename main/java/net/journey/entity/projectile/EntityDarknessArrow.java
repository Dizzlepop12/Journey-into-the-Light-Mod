...
public class EntityDarknessArrow extends EntityArrow implements IProjectile {
	...
	public EntityDarknessArrow(World worldIn, double d, double d1, double d2) {
		super(worldIn);
		this.renderDistanceWeight = 10.0D;
		this.setSize(0.5F, 0.5F);
	...
	public EntityDarknessArrow(World worldIn, EntityLivingBase e, float f) {
		super(worldIn);
		this.renderDistanceWeight = 10.0D;
		this.shootingEntity = e;
