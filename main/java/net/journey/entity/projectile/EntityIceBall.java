...
public class EntityIceBall extends EntityBasicProjectile {
	...
	public void onUpdate() {
		...
		super.onUpdate();
		for(int i = 0; i < 6; ++i) {
			Particle effect = new EntityIceballFX(this.worldObj, this.posX, this.posY - 1.0F, this.posZ, 0.0D, 0.0D, 0.0D);
	...
	protected void onImpact(RayTraceResult var1) {
		if(var1.entityHit != null) { 
			...
			((EntityLivingBase)var1.entityHit).addPotionEffect(new PotionEffect(MobEffects.SLOWNESS, 100, 5));
