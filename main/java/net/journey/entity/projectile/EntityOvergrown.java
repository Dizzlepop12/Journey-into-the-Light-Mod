...
public class EntityOvergrown extends EntityBasicProjectile {
	...
	public void onUpdate() {
		...
		super.onUpdate();
		for(int i = 0; i < 20; ++i) {
			Particle effect = new EntityOvergrownFX(this.worldObj, this.posX, this.posY - 1, this.posZ, 0.0D, 0.0D, 0.0D);
	...
	protected void onImpact(RayTraceResult var1) {
		if(var1.entityHit != null) { 
			...
			((EntityLivingBase) var1.entityHit).addPotionEffect(new PotionEffect(MobEffects.POISON, 100, 1));
		}
