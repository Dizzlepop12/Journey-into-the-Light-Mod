...
public class EntityWastefulArrow extends EntityArrow implements IProjectile {
	...
	public EntityWastefulArrow(World worldIn, EntityLivingBase e, EntityLivingBase eb, float f, float f1) {
		super(worldIn);
		this.renderDistanceWeight = 10.0D;
	...
	public EntityWastefulArrow(World worldIn, EntityLivingBase e, float f) {
		super(worldIn);
		this.renderDistanceWeight = 10.0D;
		this.shootingEntity = e;
