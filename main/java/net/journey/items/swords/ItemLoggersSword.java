...
public class ItemLoggersSword extends ItemModSword {
	...
	public ItemLoggersSword(String name, String f, EssenceToolMaterial toolMaterial) {
		super(name, f, toolMaterial);
	}

	@Override
	public boolean hitEntity(ItemStack par1ItemStack, EntityLivingBase hit, EntityLivingBase player) {
		hit.addPotionEffect(new PotionEffect(MobEffects.POISON, 1000, 200));
		hit.addPotionEffect(new PotionEffect(MobEffects.WITHER, 100, 20));
		addParticles(hit);
	...
	public void addInformation(ItemStack item, EntityPlayer player, List infoList, boolean par4) {
		infoList.add(SlayerAPI.Colour.DARK_GREEN + "On hit: Poisons enemies and grants player damage boost");
