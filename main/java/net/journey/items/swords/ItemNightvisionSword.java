...
public class ItemNightvisionSword extends ItemModSword {

	public ItemNightvisionSword(String name, String f, EssenceToolMaterial toolMaterial) {
		super(name, f, toolMaterial);
	}

	@Override
	public boolean hitEntity(ItemStack par1ItemStack, EntityLivingBase hit, EntityLivingBase player) {
		player.addPotionEffect(new PotionEffect(MobEffects.NIGHT_VISION, 10, 2));
		addParticles(hit);
