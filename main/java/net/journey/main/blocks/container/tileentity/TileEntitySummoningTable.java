package net.journey.main.blocks.container.tileentity;

import java.util.Random;

import net.journey.main.JourneyItems;
import net.journey.main.client.render.particles.EntitySummoningFX;
...
public class TileEntitySummoningTable extends TileEntity implements ITickable, IInventory {
	...
	public void addSound() {
		...
		double y = pos.getY();
		double z = pos.getZ();
		//worldObj.playSound(x, y, z, "essence:summon", 1.0F, 1.0F);
	}
	@SideOnly(Side.CLIENT)
