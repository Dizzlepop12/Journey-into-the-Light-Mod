package net.journey.main.blocks.portals;
...
import net.journey.main.dimension.ModTeleporter;
...
public class BlockTerraniaPortal extends BlockBreakable {
	...
	public static Block portal = JourneyBlocks.terraniaPortal;
	public static Block portalFrame = JourneyBlocks.terraniaPortalFrame;
	public static Block fire = JourneyBlocks.essenceFire;
	public int dimensionID = Config.terrania;
	
	public BlockTerraniaPortal(String name, String finalName) {
	...
	public boolean trySpawnPortal(World worldIn, BlockPos pos) {
		BlockTerraniaPortal.Size blockportal$size = new BlockTerraniaPortal.Size(worldIn, pos, EnumFacing.Axis.X);
		if(blockportal$size.isValid() && blockportal$size.portalBlockCount == 0) {
			blockportal$size.placePortalBlocks();
			return true;
		} else {
			BlockTerraniaPortal.Size blockportal$size1 = new BlockTerraniaPortal.Size(worldIn, pos, EnumFacing.Axis.Z);
	...
	public BlockPattern.PatternHelper createPatternHelper(World worldIn, BlockPos p_181089_2_) {
		...
		BlockTerraniaPortal.Size blockportal$size = new BlockTerraniaPortal.Size(worldIn, p_181089_2_, EnumFacing.Axis.X);
		LoadingCache<BlockPos, BlockWorldState> loadingcache = BlockPattern.createLoadingCache(worldIn, true);

		if(!blockportal$size.isValid()) {
			enumfacing$axis = EnumFacing.Axis.X;
			blockportal$size = new BlockTerraniaPortal.Size(worldIn, p_181089_2_, EnumFacing.Axis.Z);
		}
		...
		public void placePortalBlocks() {
			for(int i = 0; i < this.width; i++) {
				...
				for(int j = 0; j < this.height; ++j) {
					this.world.setBlockState(blockpos.up(j), portal.getDefaultState().withProperty(BlockTerraniaPortal.AXIS, this.axis), 2);
				}
			}
		}
	}
