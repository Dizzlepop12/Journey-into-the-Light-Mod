...
public class EntityCloudiaPortalFX extends Particle {
    ...
    public EntityCloudiaPortalFX(World var1, double var2, double var4, double var6, double var8, double var10, double var12) {
        ...
        this.particleBlue = 1.5F * rand.nextFloat();
