...
public class EntityEarthenFX extends Particle {
	
    private float portalParticleScale;
    private double portalPosX, portalPosY, portalPosZ;

    public EntityEarthenFX(World var1, double var2, double var4, double var6, double var8, double var10, double var12) {
        ...
        this.particleBlue = 0.0F + rand.nextFloat() / 2;
