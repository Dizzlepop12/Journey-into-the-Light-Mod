...
public class GuiModVillager extends GuiContainer {
	...
	protected void drawGuiContainerForegroundLayer(int var1, int var2) {
		this.fontRendererObj.drawString(LangHelper.getFormattedText(name), this.xSize / 2 - this.fontRendererObj.getStringWidth(LangHelper.getFormattedText(name)) / 2, 6, whiteName ? 0xFFFFFF : 4210752);
		this.fontRendererObj.drawString(LangHelper.getFormattedText("container.inventory"), 8, this.ySize - 96 + 2, whiteName ? 0xFFFFFF : 4210752);
	}
