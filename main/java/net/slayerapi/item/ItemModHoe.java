...
public class ItemModHoe extends ItemHoe {
	...
	public ItemModHoe(String name, String finalName, EssenceToolMaterial t){
		this(name, finalName, JourneyTabs.tools, t);
	}

	public ItemModHoe(String name, String finalName, CreativeTabs tab, EssenceToolMaterial t){
