...
public class ItemModPickaxe extends ItemPickaxe {
	...
	public ItemModPickaxe(String name, String finalName, EssenceToolMaterial t){
		this(name, finalName, JourneyTabs.tools, t);
	}

	public ItemModPickaxe(String name, String finalName, CreativeTabs tab, EssenceToolMaterial t){
