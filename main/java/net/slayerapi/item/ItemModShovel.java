...
public class ItemModShovel extends ItemSpade {
	...
	public ItemModShovel(String name, String finalName, EssenceToolMaterial t){
		this(name, finalName, JourneyTabs.tools, t);
	}

	public ItemModShovel(String name, String finalName, CreativeTabs tab, EssenceToolMaterial t){
